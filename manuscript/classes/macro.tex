...
\usepackage{tikz}
\usetikzlibrary{arrows.meta,arrows,calc}
\usepackage{tabularx}
...
\ifsetCustomMargin
  ...
  \RequirePackage[left=32mm,right=25mm,top=30mm,bottom=25mm]{geometry}
...
%\usepackage{fourier}%Utopia font: very nice
%\usepackage{fbb}%Garamond font: looks good but a bit dated
%\usepackage{gfsdidot}% Not the best maths
