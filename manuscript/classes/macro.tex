...
\newtheorem{otexample_apx}{\texttt{OpenTURNS}}
\tcolorboxenvironment{otexample_apx}{
  colback=Dandelion!3!white,
  boxrule=0.4pt,
  rounded corners,
  before skip=\topsep,
...
\newcommand{\abv}[1]{\acrshort*{#1}}
\algnewcommand{\LeftComment}[1]{\Statex \(\triangleright\) {\it #1}}
% ******************************************************************************
% *********************************** MATHS ************************************
\def\bx{{\bf x}}
\def\bX{{\bf X}}
...
\newcommand{\ots}{\href{https://openturns.github.io/www/}{\texttt{OpenTURNS}~}}
...
\def\wb{\mathbf{w}}
\def\SE{{\mathcal{E}}}%\def\SE{{\mathscr{E}}}
\def\SN{{\mathcal{N}}}%\def\SN{{\mathscr{N}}}
\def\pb{\mathbf{p}}
...
\tikzstyle{grey_rect}=[fill=white, draw={gray!20}, shape=rectangle, text centered, font={\scriptsize}, text width=2.1cm]
\tikzstyle{grey_full_rect}=[fill={gray!20}, draw={gray!20}, shape=rectangle, text centered, font={\scriptsize}, text width=2.1cm]
