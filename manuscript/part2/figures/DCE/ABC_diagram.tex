...
\textbf{Step C': Inverse analysis} \\ Sensitivity analysis}};
...
Variables \\ of interest: \\ $Y=g\left(\mathbf{X}\right)$}};
\node[rectangle,draw,fill=lightgray] (e) at (5,0) {\shortstack{
Quantities \\ of interest: \\ $\psi \left(Y\right)$}};
\node[rectangle,draw,fill=lightgray, dashed] (i) at (-1.8,-1.2) {Surrogate model};
