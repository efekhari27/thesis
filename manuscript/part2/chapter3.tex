...
but the semi-parametric inference proposed in Section~\elias{xxx} could have been an alternative. 
...
is applied to the matrix $D$ (a version of k-means using medoids). 
