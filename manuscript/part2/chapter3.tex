...
Among them, let us mention the use of parametric methods as the conditional modeling (e.g., \citealt{bitner_2015_joint,vanem_fekhari_2023}), or the construction of vine copulas (e.g., \citealt{vanem_2016,montes_2016_cvines_metocean,lin_2019_cvines_waves,lin_2019_cvines_waves}). 
...
%============================================================%
\subsection{Inference of the marginals}
%============================================================%
...
\begin{table}
    ...
    \begin{tabular}{lll}
        ...
        Significant wave height & $H_s$                     & Weibull ($\beta=2.1, \alpha=1.5, \gamma=0.5$)\\
        Wave period             & $T_p$                     & Inverse Normal ($\mu=8, \lambda=140$)\\
