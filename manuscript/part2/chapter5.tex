...
%\end{figure}
In the following, an existing Monte Carlo sample $\bZ_N$ of $N=10^3$ points in $\R^{53}$ is used, which corresponds to $53$ independent random input configurations (see \citealp{ioobou10} for details). 
