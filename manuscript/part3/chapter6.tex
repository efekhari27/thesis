...
Without going too much into details (see, e.g., \citet{chabridon_iooss_marrel_2020} for a brief presentation of these tests), depending on the nature of the analysis and the sample size, two kinds of tests are available. 
...
However, such a result is only valid for global and target analyses, not for the conditional one.
