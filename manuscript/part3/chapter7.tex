...
Let us recall the usual approach to assess fatigue damage over the structure's lifetime (see \citealt[Appendix H]{iec_2019}). 
...
%============================================================%
The method of \citet{lemaitre_2015_PLI}, later called perturbed-law based sensitivity indices (PLI) by \citet{sueur_2017_PLI} relies on perturbating densities. 
