...
\paragraph{Chapter 6 -- Rare event estimation using Bernstein adaptive nonparametric sampling.} 
%------------------------------------------------------------%
...
Among them, ``subset simulation'' \citep{AuBeck2001} is a technique based on the split of a small probability into a product of larger (and thus easier to estimate) conditional probabilities associated with nested failure events. 
...
\paragraph{Chapter 7 -- Reliability and robustness analysis of an offshore wind turbine subject to fatigue.} 
%------------------------------------------------------------%
...
\footnotetext[3]{Package documentation: \url{https://efekhari27.github.io/otkerneldesign/master/}}
\footnotetext[4]{Package repository: \url{https://github.com/efekhari27/bancs}}
\footnotetext[5]{Package repository: \url{https://github.com/efekhari27/ctbenchmark}}
\footnotetext[6]{Package repository: \url{https://github.com/efekhari27/copulogram}}