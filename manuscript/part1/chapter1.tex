...
Using the Smolyak reccurent formula (se e.g., \citealt{sullivan_2015}), two univariate quadratures can be combined as illustrated on the right of \fig{fig:bivariate_quads}. 
...
Working with Gaussian variables allows to easily write conditioning formulas between $G(\bx)$ and the observations $\by_n$. 
