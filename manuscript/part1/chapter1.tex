...
Additionally, numerical examples of the notable methods are implemented during this chapter using \texttt{OpenTURNS}, a Python package for uncertainty quantification.    
...
\begin{itemize}
    \item \textbf{aleatory uncertainty} regroups the uncertainties arising from natural randomness (e.g., soil properties). 
...
Beyond Sobol' indices, another notable GSA method was adapted from the theory of Shapley values by \citet{owen_2014_shapley}, allowing to work with dependent inputs.   
...
To deal with high dimensional problems, unimportant inputs can be screened using sensitivity analysis (see Subsection~\ref{sec:screening}), otherwise, model order reduction methods might be used \citep{schilders_2008}. 
