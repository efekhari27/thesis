...
Then, the inverse transform of the CDF is applied on marginals before adding the possible dependence effects using the Sklar theorem \eq{thm:sklar}.
...
The following $\phi_p$ criterion converges towards the minimum distance as $p$ tends to infinity:
\begin{equation} 
...
Central tendency is a probabilistic integration. 

\elias{Iso-probabilistic transformation: discuss the Li Kang Hickernell 2020 paper}

\elias{QMC is not suited for acceptance rejection method}
