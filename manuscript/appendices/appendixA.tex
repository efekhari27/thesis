...
The following \fig{fig:qqplot_kde} is a QQ-plot of the model fitted in \elias{Example xx}. The closer the scatter plot gets to the first bisector line the best the fit is.
