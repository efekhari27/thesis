...
\elias{Asymptotic behaviors of this method are decribed in: add ref}
...
The choice of bandwidth results in a bias-variance trade-off, that has been extensively discussed in the literature \elias{add ref}.
...
The following \elias{figure xx} is a QQ-plot of the model fitted in \elias{Example xx}. The closer the scatter plot gets to the first bisector line the best the fit is.
